/*============================================
 * PureCraft Shader - Pipeline Stage Alpha
 * Main Post-Processing Stage
 * Atmospheric & Volumetric Effects by EminGT
 *============================================*/
...
// Advanced shadow time calculations for atmospheric effects - EminGT Enhancement
...
//========================================
// Atmospheric & Effects Libraries - EminGT Organization
//========================================
...
#if WATER_MAT_QUALITY >= 3 || defined COLORED_LIGHT_FOG
...
void main() {
    ...
    // Screen to view space transformation - EminGT Enhancement
    ...
    // Temporal dithering for noise reduction - EminGT
    ...
    The "1.0 - translucentMult" ensures proper transparency handling - EminGT */
    ...
    #if RAINBOWS > 0 && defined OVERWORLD
        // Rainbow atmospheric phenomena processing - EminGT
        if (isEyeInWater == 0) color += GetRainbow(translucentMult, z0, z1, lViewPos, lViewPos1, VdotL, dither);
    #endif

    #ifdef LIGHTSHAFTS_ACTIVE
        // Volumetric lighting computation - EminGT Enhancement
    ...
    #endif
    #ifdef MOON_PHASE_INF_ATMOSPHERE
        // Moon phase atmospheric influence - EminGT
        volumetricEffect.rgb *= moonPhaseInfluence;
    #endif

    #ifdef COLORED_LIGHT_FOG
        // Advanced colored lighting fog system - EminGT Implementation
    ...
    // Underwater and lava rendering adjustments - EminGT Enhancement
    if (isEyeInWater == 1) {
    ...
    #ifdef COLORED_LIGHT_FOG
        // Advanced light fog integration - EminGT Algorithm
    ...
    // Advanced lightshaft quality control - EminGT Optimization
...
void main() {
    ...
    // Direction vector calculations - EminGT Enhancement
