                        ...
                        if (mat < 10016) {
                            if (mat < 10008) {
                                if (mat < 10004) { // No directional shading
                                    ...
                                    // PureCraft Shader Enhanced Flowers: FIXED - Better grass exclusion
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                                    
                                    // IMPROVED grass detection to prevent glowing grass
                                    bool isAnyGrass = (color.g > 0.25 && color.g > color.r * 1.05 && color.g > color.b * 1.05) || 
                                                     (totalColor < 1.5 && color.g > 0.35); // Extra protection for typical grass colors
                                    bool isBrightColorfulFlower = (totalColor > 1.3 && colorVariance > 0.2 && color.r > 0.4); // Stricter flower criteria
                                    
                                    if (isBrightColorfulFlower && !isAnyGrass) {
                                        // Include only very obvious flowers, exclude all grass types
                                        #include "/lib/specificMaterials/terrain/flowers.glsl"
                                    }
                            ...
                            if (mat < 10024) {
                                if (mat < 10020) { // Non-waving Foliage
                                    ...
                                    // PureCraft Shader Enhanced Flowers: FIXED - Better grass exclusion (Non-waving)
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                                    ...
                                    // PureCraft Shader Enhanced Flowers: FIXED - Better detection and grass exclusion
                                    float totalColor = color.r + color.g + color.b;
                                    float colorVariance = max(max(abs(color.r - color.g), abs(color.g - color.b)), abs(color.b - color.r));
                                    
                                    // IMPROVED grass detection to prevent ANY grass from glowing
                                    bool isAnyGrass = (color.g > 0.25 && color.g > color.r * 1.05 && color.g > color.b * 1.05) || 
                                                     (totalColor < 1.5 && color.g > 0.35) ||
                                                     (color.g > 0.4 && colorVariance < 0.25); // Additional grass protection
                                    bool isBrightColorfulFlower = (totalColor > 1.3 && colorVariance > 0.2 && color.r > 0.4); // Stricter flower criteria
                                    
                                    if (isBrightColorfulFlower && !isAnyGrass) {
                                        // This appears to be a colorful flower, apply glowing effect
                                        #include "/lib/specificMaterials/terrain/flowers.glsl"
                                    }
                        ...
                        if (mat < 10048) {
                            if (mat < 10040) {
                                if (mat < 10036) { // Stone Bricks++
                                    #include "/lib/specificMaterials/terrain/stone.glsl"

                                }
                                else /*if (mat < 10040)*/ { // Anvil+
                                    #include "/lib/specificMaterials/terrain/anvil.glsl"
                                }
                            } else {
                                if (mat < 10044) { // Rails
                                    ...
                                    if (color.r > 0.1 && color.g + color.b < 0.1) { // Redstone Parts
                                        ...
                                        #include "/lib/specificMaterials/terrain/ironBlock.glsl"
                                    } else if (color.g > color.b * 2.0) { // Gold Parts
                                        #include "/lib/specificMaterials/terrain/goldBlock.glsl"
                                    } else { // Wood Parts
                                        #include "/lib/specificMaterials/planks/oakPlanks.glsl"
                                    }
                                }
                            ...
                            if (mat < 10056) {
                                if (mat < 10052) { // Water Cauldron
                                    ...
                                    if (max(coordM.x, coordM.y) < 0.375 &&
                                        ...
                                        #include "/lib/specificMaterials/terrain/snow.glsl"
                                    } else {
                                        #include "/lib/specificMaterials/terrain/anvil.glsl"
                                    }
                                }
                                ...
                                if (mat < 10060) { // Lava Cauldron
                                    ...
                                    if (max(coordM.x, coordM.y) < 0.375 &&
                                        ...
                                        #include "/lib/specificMaterials/terrain/lava.glsl"
                                    } else {
                                        #include "/lib/specificMaterials/terrain/anvil.glsl"
                                    }
                                }
                                    ...
                                    if (color.r > color.g + color.b) {
                                        ...
                                        #include "/lib/specificMaterials/terrain/cobblestone.glsl"
                                    }
                                }
                            }
                        }
                        ...
                        if (mat < 10080) {
                            if (mat < 10072) {
                                ...
                                if (mat < 10076) { // Fire
                                    ...
                                    emission = 2.35;
                                    #ifdef NETHER
                                        emission *= 0.4; // PureCraft Shader: Reduce fire emission in Nether
                                    #endif
                                    ...
                                    emission = 1.5;
                                    #ifdef NETHER
                                        emission *= 0.4; // PureCraft Shader: Reduce soul fire emission in Nether
                                    #endif
                        ...
                        if (mat < 10112) {
                            if (mat < 10104) {
                                ...
                                if (mat < 10108) { // Polished Andesite+, Packed Mud, Mud Bricks+, Bricks+
                                    ...
                                    #include "/lib/specificMaterials/terrain/deepslate.glsl"
                                }
                            }
                        } else {
                            if (mat < 10120) {
                                ...
                                if (mat < 10124) { // Dripstone+, Daylight Detector
                                    ...
                                    if (dotColor > 1.5) { // Snowy Variants:Snowy Part
                                        ...
                                        #include "/lib/specificMaterials/terrain/dirt.glsl"
                                    }
                                }
                            }
                        }
                        ...
                        if (mat < 10144) {
                            if (mat < 10136) {
                                ...
                                if (mat < 10140) { // Farmland:Wet
                                    ...
                                    #include "/lib/specificMaterials/terrain/netherrack.glsl"
                                }
                            }
                        } else {
                            if (mat < 10152) {
                            ...
                            if (mat < 10168) {
                                if (mat < 10164) { // Oak Log, Oak Wood
                                    if (color.g > 0.48 ||
                                        ...
                                        #include "/lib/specificMaterials/terrain/oakWood.glsl"
                                    }
                                }
                                else /*if (mat < 10168)*/ { // Spruce Planks++:Clean Variants
                                    #include "/lib/specificMaterials/planks/sprucePlanks.glsl"
                                }
                            } else {
                                if (mat < 10172) { // Spruce Log, Spruce Wood
                                    ...
                                    #include "/lib/specificMaterials/planks/birchPlanks.glsl"
                                }
                            }
                        } else {
                            if (mat < 10184) {
                                if (mat < 10180) { // Birch Log, Birch Wood
                                    ...
                                    #include "/lib/specificMaterials/planks/junglePlanks.glsl"
                                }
                            } else {
                                if (mat < 10188) { // Jungle Log, Jungle Wood
                                    ...
                                    #include "/lib/specificMaterials/planks/acaciaPlanks.glsl"
                                }
                            }
                        }
                    }
                        ...
                        if (mat < 10208) {
                            if (mat < 10200) {
                                if (mat < 10196) { // Acacia Log, Acacia Wood
                                    ...
                                    #include "/lib/specificMaterials/planks/darkOakPlanks.glsl"
                                }
                            } else {
                                if (mat < 10204) { // Dark Oak Log, Dark Oak Wood
                                    ...
                                    #include "/lib/specificMaterials/planks/mangrovePlanks.glsl"
                                }
                            }
                        } else {
                            if (mat < 10216) {
                                if (mat < 10212) { // Mangrove Log, Mangrove Wood
                                    ...
                                    #include "/lib/specificMaterials/planks/crimsonPlanks.glsl"
                                }
                            } else {
                                if (mat < 10220) { // Crimson Stem, Crimson Hyphae
                                    ...
                                    #include "/lib/specificMaterials/planks/warpedPlanks.glsl"
                                }
                            }
                        }
                    } else {
                        if (mat < 10240) {
                            ...
                            if (mat < 10248) {
                                ...
                                if (mat < 10252) { // Netherite Block
                                    #include "/lib/specificMaterials/terrain/netheriteBlock.glsl"
                                }
                        ...
                        if (mat < 10272) {
                            if (mat < 10264) {
                                ...
                                if (mat < 10268) { // Iron Block, Heavy Weighted Pressure Plate
                                    ...
                                    #include "/lib/specificMaterials/terrain/rawIronBlock.glsl"
                                }
                            }
                        } else {
                            if (mat < 10280) {
                                ...
                                if (mat < 10284) { // Raw Copper Block
                                    #include "/lib/specificMaterials/terrain/rawCopperBlock.glsl"
                                }
                        ...
                        if (mat < 10304) {
                            if (mat < 10296) {
                                if (mat < 10292) { // Deepslate Copper Ore
                                    ...
                                    #include "/lib/specificMaterials/terrain/copperBlock.glsl"
                                }
                            } else {
                                if (mat < 10300) { // Raw Gold Block
                                    #include "/lib/specificMaterials/terrain/rawGoldBlock.glsl"
                                }
                            ...
                            if (mat < 10312) {
                                ...
                                if (mat < 10316) { // Gold Block, Light Weighted Pressure Plate
                                    ...
                                    #include "/lib/specificMaterials/terrain/diamondBlock.glsl"
                                }
                            }
                        }
                    }
                        ...
                        if (mat < 10336) {
                            ...
                            if (mat < 10344) {
                                if (mat < 10340) { // Emerald Block
                                    #include "/lib/specificMaterials/terrain/emeraldBlock.glsl"
                                }
                        ...
                        if (mat < 10368) {
                            if (mat < 10360) {
                                if (mat < 10356) { // Lapis Block
                                    #include "/lib/specificMaterials/terrain/lapisBlock.glsl"
                                ...
                                if (mat < 10364) { // Deepslate Lapis Ore
                                    ...
                                    #include "/lib/specificMaterials/terrain/quartzBlock.glsl"
                                }
                            }
                        } else {
                            if (mat < 10376) {
                                if (mat < 10372) { // Nether Quartz Ore
                                    ...
                                    #include "/lib/specificMaterials/terrain/obsidian.glsl"
                                }
                            } else {
                        ...
                        if (mat < 10400) {
                            if (mat < 10392) {
                                ...
                                if (mat < 10396) { // Pumpkin, Carved Pumpkin
                                    #include "/lib/specificMaterials/terrain/pumpkin.glsl"
                                }
                            ...
                            if (mat < 10408) {
                                ...
                                if (mat < 10412) { // Basalt+
                                    ...
                                    #ifdef NETHER
                                        emission *= 0.3; // PureCraft Shader: Significantly reduce glowstone emission in Nether
                                    #endif
                        ...
                        if (mat < 10432) {
                            if (mat < 10424) {
                                ...
                                if (mat < 10428) { // Melon
                                    ...
                                    #include "/lib/specificMaterials/terrain/endStone.glsl"
                                }
                            }
                        } else {
                            if (mat < 10440) {
                        ...
                        if (mat < 10464) {
                            ...
                            if (mat < 10472) {
                                if (mat < 10468) { // Concrete Powder+
                                    ...
                                    #include "/lib/specificMaterials/terrain/coral.glsl"
                                }
                            } else {
                                if (mat < 10476) { // Coral Fan+, Coral+
                                    ...
                                    #include "/lib/specificMaterials/terrain/cryingObsidian.glsl"
                        ...
                        if (mat < 10496) {
                            if (mat < 10488) {
                                if (mat < 10484) { // Blackstone++
                                    #include "/lib/specificMaterials/terrain/blackstone.glsl"
                                }
                            ...
                            if (mat < 10504) {
                                if (mat < 10500) { // Torch
                                    ...
                                    if (color.r > 0.95) {
                                        ...
                                        #endif
                                        #ifdef NETHER
                                            emission *= 0.4; // PureCraft Shader: Reduce torch emission in Nether
                                        #endif
                                        color.r *= 1.4;
                                        color.b *= 0.5;
                                    } 
                                ...
                                if (mat < 10508) { // Chorus Plant
                                    ...
                                    if (dotColor > 1.0) {
                                        ...
                                        // Reduced mystical purple glow for Chorus Flower
                                        emission *= 1.0; // Reduced from 1.5
                                        color.rgb *= vec3(1.05, 0.98, 1.1); // More subtle enhancement
                                    }
                                }
                            }
                        }
            ...
            if (mat < 10640) {
                            ...
                            if (mat < 10520) {
                                if (mat < 10516) { // Chorus Flower:Dead
                                    ...
                                    if (CheckForColor(checkColor, vec3(164, 157, 126)) ||
                                        ...
                                        emission = min(dot(color.rgb, vec3(0.299, 0.587, 0.114)), 0.75) / 0.75;
                                        emission = pow2(pow2(emission)) * 6.5;
                                        // Reduced warm glow for dead chorus flower
                                        emission *= 0.8; // Reduced from 1.3
                                        color.rgb *= vec3(1.08, 1.05, 0.95); // More subtle golden glow
                                        color.gb *= 0.85;
                        ...
                        if (mat < 10560) {
                            if (mat < 10552) {
                                ...
                                if (mat < 10556) { // End Portal Frame:Inactive
                                    ...
                                    if (abs(color.r - color.g - 0.05) < 0.10) {
                                        ...
                                        #include "/lib/specificMaterials/terrain/endPortalFrame.glsl"
                                    }
                            ...
                            if (mat < 10568) {
                                if (mat < 10564) { // Lantern
                                    ...
                                    #include "/lib/specificMaterials/terrain/lanternMetal.glsl"

                                    emission = 4.3 * max0(color.r - color.b);
                                    emission += min(pow2(pow2(0.75 * dot(color.rgb, color.rgb))), 5.0);
                                    #ifdef NETHER
                                        emission *= 0.4; // PureCraft Shader: Reduce lantern emission in Nether
                                    #endif
                        ...
                        if (mat < 10592) {
                            ...
                            if (mat < 10600) {
                                if (mat < 10596) { // Respawn Anchor:Lit
                                    ...
                                    #include "/lib/specificMaterials/terrain/redstoneBlock.glsl"
                                ...
                                if (mat < 10604) { // Redstone Wire:Unlit
                                    ...
                                    #include "/lib/specificMaterials/terrain/redstoneTorch.glsl"
                                    emission += 0.0001; // No light reducing during noon
                ...
                if (mat < 10704) {
                        ...
                        if (mat < 10688) {
                            if (mat < 10680) {
                                ...
                                if (mat < 10684) { // Ochre Froglight
                                    float frogPow = 8.0;
                                    #include "/lib/specificMaterials/terrain/froglights.glsl"
                                }
                    ...
                    if (mat < 10736) {
                        if (mat < 10720) {
                            ...
                            if (mat < 10728) {
                                ...
                                if (mat < 10732) { // Flower Pot, Potted Stuff:Without Subsurface
                                    ...
                                    // Check if this is a flower in a pot by analyzing colors
                                    float colorIntensity = dot(color.rgb, vec3(1.0));
                                    if (colorIntensity > 0.8 && (color.r > 0.3 || color.g > 0.3 || color.b > 0.3)) {
                                        // This looks like a colorful flower, apply glowing effect
                                        #include "/lib/specificMaterials/terrain/flowers.glsl"
                                    }
                                }
                        ...
                        if (mat < 10752) {
                            if (mat < 10744) {
                                if (mat < 10740) { // Structure Block, Jigsaw Block, Test Block, Test Instance Block
                                    float blockRes = absMidCoordPos.x * atlasSize.x;
                                    vec2 signMidCoordPosM = (floor((signMidCoordPos + 1.0) * blockRes) + 0.5) / blockRes - 1.0;
                                    float dotsignMidCoordPos = dot(signMidCoordPosM, signMidCoordPosM);
                            ...
                            if (mat < 10760) {
                                if (mat < 10756) { // Bamboo
                                    ...
                                    #include "/lib/specificMaterials/planks/bambooPlanks.glsl"
                                }
                            } else {
                                if (mat < 10764) { // Cherry Planks++
                                    #include "/lib/specificMaterials/planks/cherryPlanks.glsl"
                                }
                        ...
                        if (mat < 10784) {
                            if (mat < 10776) {
                                if (mat < 10772) { // Torchflower
                                    #include "/lib/specificMaterials/terrain/torchflower.glsl"
                                }
                                ...
                                if (mat < 10780) { // Crimson Fungus, Warped Fungus
                                    ...
                                    if (color.r > 0.91) { // Crimson Fungus - Red
                                        emission = 2.5 * color.g; // Reduced from 3.5
                                        color.r *= 1.2; // Reduced from 1.3
                                        color.rgb *= vec3(1.05, 0.98, 0.95); // More subtle enhancement
                                        maRecolor = vec3(0.1);
                                    } else if (color.b > 0.6) { // Warped Fungus - Blue/Cyan
                                        emission = 2.0 + color.b * 1.5; // Reduced from 2.8 + 2.0
                                        color.rgb *= vec3(0.95, 1.02, 1.1); // More subtle enhancement
                                        maRecolor = vec3(0.1);
                                    }
                                }
                                    ...
                                    float NdotE = dot(normalM, eastVec);
                                    if (abs(abs(NdotE) - 0.5) < 0.4) {
                                        if (color.r > 0.91) { // Potted Crimson Fungus - Red
                                            emission = 2.5 * color.g; // Reduced glow
                                            color.r *= 1.2;
                                            color.rgb *= vec3(1.05, 0.98, 0.95); // More subtle enhancement
                                            maRecolor = vec3(0.1);
                                        } else if (color.b > 0.6) { // Potted Warped Fungus - Blue/Cyan
                                            emission = 2.0 + color.b * 1.5; // Reduced glow
                                            color.rgb *= vec3(0.95, 1.02, 1.1); // More subtle enhancement
                                            maRecolor = vec3(0.1);
                                        }
                                    }
                        ...
                        if (mat < 10848) {
                            ...
                            if (mat < 10856) {
                                if (mat < 10852) { // Crafter
                                    ...
                                    #include "/lib/specificMaterials/terrain/copperBulb.glsl"
                                }
                            } else {
                ...
                if (mat < 10960) {
                    if (mat < 10928) {
                        if (mat < 10900) { // Iron Trapdoor
                            ...
                            #include "/lib/specificMaterials/terrain/candle.glsl"
                        }
                        else /*if (mat < 10928)*/ { //
                        ...
                        if (mat < 10944) {
                            if (mat < 10936) {
                                if (mat < 10932) { // Pale Oak Planks++
                                    #include "/lib/specificMaterials/planks/paleOakPlanks.glsl"
                                }
                                    ...
                                    if (color.g > 0.45) { // Pale Oak Log:Clean Part
                                        ...
                                        #include "/lib/specificMaterials/terrain/paleOakWood.glsl"
                                    }
                                }
                            } else {
                        ...
                        if (mat < 10976) {
                            ...
                            if (mat < 10984) {
                                if (mat < 10980) { // Open Eyeblossom
                                    #include "/lib/specificMaterials/terrain/openEyeblossom.glsl"
                                }
                                else /*if (mat < 10984)*/ { //
                                    noSmoothLighting = true;
...
// PureCraft Shader: Global emission reduction system for Nether
#ifdef NETHER
    if (emission > 0.1) {
        emission *= 0.6; // Additional global reduction for any remaining bright emissions in Nether
    }
#endif
