...
//Includes//
#include "../lib/color_grading/blocklightColor.glsl"
#include "../lib/color_grading/dimensionColor.glsl"
#include "../lib/color_grading/lightSkyColor.glsl"
#include "../lib/color_grading/skyColor.glsl"
#include "../lib/color_grading/specularColor.glsl"
#include "../lib/color_grading/waterColor.glsl"
#include "../lib/utility_functions/dither.glsl"
#include "../lib/utility_functions/spaceConversion.glsl"
#include "../lib/sky_effects/weatherDensity.glsl"
#include "../lib/sky_effects/sky.glsl"
#include "../lib/sky_effects/clouds.glsl"
#include "../lib/sky_effects/fog.glsl"
#include "../lib/sky_effects/waterFog.glsl"
#include "../lib/light_engine/dynamicHandlight.glsl"
#include "../lib/light_engine/forwardLighting.glsl"
#include "../lib/mirror_effects/raytrace.glsl"
#include "../lib/mirror_effects/simpleReflections.glsl"
#include "../lib/material_effects/ggx.glsl"
#include "../lib/material_effects/hardcodedEmission.glsl"
...
#ifdef ADVANCED_MATERIALS
#include "../lib/mirror_effects/complexFresnel.glsl"
#include "../lib/material_effects/directionalLightmap.glsl"
#include "../lib/material_effects/materialGbuffers.glsl"
#include "../lib/material_effects/parallax.glsl"

#ifdef REFLECTION_RAIN
#include "../lib/mirror_effects/rainPuddles.glsl"
#endif
#endif

#ifdef MULTICOLORED_BLOCKLIGHT
// VoxelMap support removed
#endif

#if defined MULTICOLORED_BLOCKLIGHT || defined MCBL_SS
#include "../lib/light_engine/coloredBlocklight.glsl"
#endif
...
void main() {
	...
	if (albedo.a > 0.001) {
		...
		#if CLOUDS == 2
		float cloudMaxDistance = 8.0 * far;
		#ifdef DISTANT_HORIZONS
		cloudMaxDistance = max(cloudMaxDistance, dhFarPlane * 2.0);
		#endif
...
#include "../lib/vertex_processing/worldCurvature.glsl"
#endif
