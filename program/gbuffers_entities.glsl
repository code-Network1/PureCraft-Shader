...
void main() {
	...
	// Exclude blob shadow from selective TAA
	float entityMask = (color.a > 0.999) ? 0.25 : 0.0;
    ...
    gl_FragData[0] = albedo;
		...
		/* DRAWBUFFERS:083 */
		gl_FragData[2] = vec4(0.0, 0.0, entityMask, 1.0);
		#endif
		...
		#if defined TAA_SELECTIVE && !(defined ADVANCED_MATERIALS && defined REFLECTION_SPECULAR)
		/* DRAWBUFFERS:03 */
		gl_FragData[1] = vec4(0.0, 0.0, entityMask, 1.0);
		#endif

		#if defined ADVANCED_MATERIALS && defined REFLECTION_SPECULAR
		/* DRAWBUFFERS:0367 */
		gl_FragData[1] = vec4(smoothness, skyOcclusion, entityMask, 1.0);
